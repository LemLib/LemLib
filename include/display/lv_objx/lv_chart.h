 ...
 */
static inline void lv_chart_set_style(lv_obj_t* chart, lv_style_t* style) { lv_obj_set_style(chart, style); }
 ...
 */
static inline lv_style_t* lv_chart_get_style(const lv_obj_t* chart) { return lv_obj_get_style(chart); }
