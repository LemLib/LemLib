...
#define SYMBOL_DUMMY                                                                                                   \
    _SYMBOL_VALUE1(FF) /*Invalid symbol. If written before a string then `lv_img` will show it as a label*/
...
#define SYMBOL_DUMMY                                                                                                   \
    _SYMBOL_VALUE3(                                                                                                    \
        EF, A3, BF) /*Invalid symbol at (U+F831). If written before a string then `lv_img` will show it as a label*/
#endif
