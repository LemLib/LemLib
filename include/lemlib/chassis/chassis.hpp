...
public:
   ...
   * @param the scale inputted into the drive curve function for linear
   * velocity.
   * @param the scale inputted into the drive curve function for turn
   * velocity.If you are using the default drive curve, refer to the
   * `defaultDriveCurve` documentation.
   *
   */
  void arcade(int throttle, int turn, float throttleCurveGain = 0.0,
              float turnCurveGain = 0);
  /**
   ...
   * @param the scale inputted into the drive curve function for linear
   * velocity.
   * @param the scale inputted into the drive curve function for turn velocity.
   * If you are using the default drive curve, refer to the `defaultDriveCurve`
   * documentation.
   */
  void curvature(int throttle, int turn, float throttleCurveGain = 0.0,
                 float turnCurveGain = 0);
