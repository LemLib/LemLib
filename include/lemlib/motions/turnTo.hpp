...
struct TurnToParams {
     ...
     * between 0-1. 0 by default */
    Number minSpeed = 0;
    /** how much the power (from -1 to +1) can increase per second. Defaults to
     * 0 */
    Number slew = 0;
...
struct TurnToSettings {
    ...
    /** this function should return the estimated pose of the robot, typically
     * by the tracking wheel odometry. */
 ...
 */
void turnTo(std::variant<Angle, units::V2Position> target,
            Time timeout,
            TurnToParams params,
