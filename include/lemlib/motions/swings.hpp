 ...
 */
class DifferentialSwing : public DifferentialMotion {
    public:
        /**
         ...
         */
        DifferentialSwing(PID& angularPID, float target, int timeout, DriveSide lockedSide, SwingToParams& params);
         ...
         * @param params parameters for the motion
         */
        DifferentialSwing(PID& angularPID, Pose target, int timeout, DriveSide lockedSide, SwingToParams& params);
