...
class Motor {
    public:
         ...
         */
        [[deprecated("Changing these values is not supported by VEX and may lead to permanent motor "
                     "damage.")]] static motor_pid_s_t
         ...
         */
        [[deprecated(
            "Changing these values is not supported by VEX and may lead to permanent motor damage.")]] virtual std::
            int32_t
