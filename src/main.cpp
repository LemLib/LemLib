...
// drive motors
pros::Motor lF(-5,
               pros::E_MOTOR_GEARSET_06); // left front motor. port 5, reversed
pros::Motor lM(4, pros::E_MOTOR_GEARSET_06); // left middle motor. port 4
pros::Motor lB(-3,
               pros::E_MOTOR_GEARSET_06); // left back motor. port 3, reversed
pros::Motor rF(6, pros::E_MOTOR_GEARSET_06); // right front motor. port 6
pros::Motor
    rM(-9, pros::E_MOTOR_GEARSET_06); // right middle motor. port 9, reversed
...
// vertical tracking wheel encoder. Rotation sensor, port 11, reversed (negative
// signs don't work due to a pros bug)
