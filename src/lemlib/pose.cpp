 ...
 * @return Pose
 */
float Pose::operator*(const Pose& other) const { return (this->x * other.x + this->y * other.y).raw(); } // todo
 ...
 * @return Angle
 */
Angle Pose::angle(Pose other) const { return units::atan2(other.y - this->y, other.x - this->x); }
