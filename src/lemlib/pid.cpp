 ...
 */
template <isQuantity Q> FAPID<Q>::FAPID(float kF, float kA, float kP, float kI, float kD, std::string name) {
    this->kF = kF;
    this->kA = kA;
    this->kP = kP;
    this->kI = kI;
 ...
 * @param kD derivative gain, multiplied by change in error and added to output
 */
template <isQuantity Q> void FAPID<Q>::setGains(float kF, float kA, float kP, float kI, float kD) {
    this->kF = kF;
    this->kA = kA;
    this->kP = kP;
    this->kI = kI;
...
void FAPID<Q>::setExit(Q largeError, Q smallError, Time largeTime, Time smallTime, Time maxTime) {
 ...
 * @return float - output
 */
template <isQuantity Q> float FAPID<Q>::update(Q target, Q position, bool log) {
 ...
 */
template <isQuantity Q> void FAPID<Q>::reset() {
    prevError = Q(0);
    totalError = Q(0);
    prevOutput = 0;
}
 ...
 */
template <isQuantity Q> bool FAPID<Q>::settled() {
 ...
 * reset()
 */
template <isQuantity Q> void FAPID<Q>::init() {
    if (logTask != nullptr) {
...
template <isQuantity Q> void FAPID<Q>::log() {
